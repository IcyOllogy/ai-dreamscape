...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The most realistic AI companionship platform. Meet your dream girl today. Private, secure, and incredibly real." },
    ],
  }),
  component: Index,
});
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
        ...
        <div className="container relative z-10 px-6 lg:px-12">
          <div className="max-w-3xl animate-slide-up">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-xl leading-relaxed mb-10">
              Immerse yourself in private, high-fidelity conversations with AI companions who remember every detail. No judgment. No limits. Just pure connection.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <Link to="/chat" className="px-10 py-4 glass-card rounded-full font-semibold flex items-center gap-2">
      ...
      <section className="py-24 px-6 lg:px-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            ...
            <p className="text-muted-foreground">The most popular presences in the Dreamscape this week.</p>
          </div>
          <Link to="/companions" className="text-primary font-semibold flex items-center gap-1 hover:underline">
            ...
            >
              ...
              <div className="absolute bottom-0 inset-x-0 p-4">
                <div className="flex items-center justify-between mb-1">
                  <h3 className="text-lg font-bold truncate">{c.name}, {c.age}</h3>
                  <div className={`w-2 h-2 rounded-full ${c.online ? 'bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.6)]' : 'bg-zinc-500'}`} />
                </div>
                ...
                <div className="flex items-center gap-2">
                  <span className="text-[10px] uppercase tracking-widest text-primary font-bold">Chat Now</span>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-12 text-center md:text-left">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Your conversations are fully encrypted and private. No logs, no leaks, just your personal fantasy.
            </p>
          </div>
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              No waiting, no ghosting. Our AI companions are always online and ready to chat when you are.
            </p>
          </div>
          <div className="space-y-4">
            <div className="w-12 h-12 rounded-2xl bg-primary/20 flex items-center justify-center mx-auto md:mx-0">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              They remember your name, your likes, and your history. Every conversation builds a deeper connection.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 text-center px-6">
        ...
        <Link to="/signup" className="neon-button px-12 py-5 text-lg inline-flex items-center gap-2">
          Create Your Dream Companion <ChevronRight className="w-5 h-5" />
        </Link>
        <p className="mt-8 text-muted-foreground text-sm">Join 100,000+ members exploring their fantasies.</p>
      </section>
    </div>
  );
}
