  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <Link
          to="/"
          className="mt-8 inline-block px-6 py-3 text-xs uppercase tracking-[0.25em] bg-primary text-primary-foreground hover:bg-primary/90"
        >
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <button
          ...
          className="mt-8 px-6 py-3 text-xs uppercase tracking-[0.25em] bg-primary text-primary-foreground"
        >
          Try again
        </button>
      </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Noctis — Cinematic AI Companions" },
      {
        name: "description",
        content:
          "A luxe AI companionship platform. Slow conversation, beautiful presence, mature themes. 18+.",
      },
      { name: "theme-color", content: "#020202" },
      { property: "og:title", content: "Noctis — Cinematic AI Companions" },
      {
        property: "og:description",
        content: "A luxe AI companionship platform crafted for grown-ups.",
      },
