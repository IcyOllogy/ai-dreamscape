    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-background/85 backdrop-blur-xl px-4 animate-fade-in">
      ...
      <div className="relative max-w-md w-full gold-border rounded-sm bg-card/90 p-10 text-center glow-gold">
        ...
        <h2 className="font-display text-4xl text-ivory leading-tight">
          Are you over <span className="gold-text">eighteen</span>?
        </h2>
        <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
          This experience contains mature themes intended for adult audiences. By entering you
        ...
        <div className="mt-8 flex flex-col gap-3">
          ...
          <a
            ...
            className="w-full py-3 text-xs uppercase tracking-[0.25em] text-muted-foreground hover:text-ivory transition-colors"
          >
            Take me away
          </a>
        </div>
